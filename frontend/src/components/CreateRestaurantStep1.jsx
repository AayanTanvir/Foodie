	...
	return (
		<>
			<div className='w-full h-fit flex flex-col justify-start items-start gap-6'>
				...
				<button onClick={() => { handleContinue() }} className='w-fit mt-8 px-3 py-2 bg-neutral-800 text-white font-opensans font-semibold rounded-md hover:bg-neutral-700 transition'>
					Continue
				</button>
