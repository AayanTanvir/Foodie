    ...
    return (
        <div className='relative min-h-[250px] w-full py-4 mt-6'>
            ...
            <div className='absolute left-[24rem] top-6'>
                <h1 className='text-5xl font-notoserif font-semibold text-left'>{restaurant.name}</h1>
                <h1 className='text-md font-roboto font-normal text-left mb-8'>{restaurant.restaurant_category}</h1>
                <h1 className='text-md font-roboto font-normal text-left'>Ratings: <span className='text-amber-500'>4.1</span></h1>
                <h1 className='text-md font-roboto font-normal text-left'>{formattedTimings}</h1>
            </div>
            ...
            <div className='absolute right-24 bottom-0 w-fit h-18 p-2'>
                <h1 className='text-md font-roboto font-normal text-right'>{restaurant.phone}</h1>
                <h1 className='text-md font-roboto font-normal text-right'>{restaurant.address}</h1>
            </div>
        </div>
    )
}
