...
const LoginPage = () => {
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-screen flex items-center justify-center flex-col">
      ...
      <form onSubmit={loginUser} className="w-1/4 bg-slate-100 border-0 rounded flex flex-col items-center p-6 gap-4">
        ...
        <p className='mt-8'>Don't have an account? <Link to='/signup' className='text-blue-400'>Signup!</Link></p>
      </form>
    </div>
  );
};
